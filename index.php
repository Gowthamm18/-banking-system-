 ...
 <?php
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-4">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img src="img/abcd.jpg" class="img-fluid pt-3" style="height:800px;">
              </div>
            </div>
      ...
      <!-- Activity section -->
            <div class="row activity text-center" style="background-color: #faebd7;">
                  <div class="col-md act">
                    ...
                    <img src="img/OIP (1).jpg" class="img-fluid" style="height:250px;">
                    <br>
                    <a href="transfermoney.php"><button style="background-color : #008080;">Transaction</button></a>
                  </div>
                  <div class="col-md act">
                    <img src="img/OIP (2).jpg" class="img-fluid" style="height:250px;">
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
            <p>&copy Made by <b>GOWTHAM ADISHTI</b></p>
      </footer>
